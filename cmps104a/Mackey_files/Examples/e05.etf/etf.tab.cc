...
{
  "$end", "error", "$undefined", "IDENT", "ADD", "MUL", "LPAR", "RPAR",
...
/* Line 1455 of yacc.c  */
#line 44 "etf.yy"
    {(yyval) = trace (adopt2 ((yyvsp[(2) - (3)]), (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]))); ;}
    break;
