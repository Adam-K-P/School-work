...
class directory: public file_base {
   ...
   public:
      ...
      inode_ptr mkdir (const string& dirname, inode_ptr cwd);
      inode_ptr mkfile (const string& filename);
      inode_ptr find_dir (const string& dirname);
      void insert_parent (inode_ptr this_dir, inode_ptr parent);
